...
export const Camera = () => {
  ...
  const handleCameraError = (error) => {
    ...
    const err = {};
    err[activeTab] = {
        serverErr: "There was a problem accessing the WEBCAM. Grant permission and reload the page.",
    };
    dispatch(setAuthError(err));
};

    const MODEL_BASE_URL =
        "https://raw.githubusercontent.com/RaphealJames07/face-recognition-models/main";
